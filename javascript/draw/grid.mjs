...
function drawBackwardSlantedLines(base, spacing, offsetX = 0, offsetY = 0) {
...
function drawForwardSlantedLines(base, spacing, offsetX = 0, offsetY = 0) {
  for (let x = canvas.centre.x; x > -base; x -= spacing) {
    context.moveTo(x + offsetX, offsetY)
    context.lineTo(x - base + offsetX, canvas.height + offsetY)
  }
...
function drawHexagonalLine() {
  ...
  drawBackwardSlantedLines(equilateralTriangleBase, sideLength * 3, offsetX, offsetY)
  context.stroke()
  ...
  drawBackwardSlantedLines(equilateralTriangleBase, sideLength * 3, sideLength + offsetX, offsetY)
  context.stroke()
  ...
  drawBackwardSlantedLines(equilateralTriangleBase, sideLength * 3, sideLength * 2 + offsetX, offsetY)
  context.stroke()
  ...
  context.setLineDash([sideLength, sideLength * 2])
  context.lineDashOffset = sideLength
  drawForwardSlantedLines(equilateralTriangleBase, sideLength * 3, -offsetX, offsetY)
  context.stroke()
  ...
  context.setLineDash([sideLength, sideLength * 2])
  context.lineDashOffset = 0
  drawForwardSlantedLines(equilateralTriangleBase, sideLength * 3, -(sideLength + offsetX), offsetY)
  context.stroke()
  ...
  context.setLineDash([sideLength, sideLength * 2])
  context.lineDashOffset = sideLength * 2
  drawForwardSlantedLines(equilateralTriangleBase, sideLength * 3, -(sideLength * 2 + offsetX), offsetY)
  context.stroke()
}
